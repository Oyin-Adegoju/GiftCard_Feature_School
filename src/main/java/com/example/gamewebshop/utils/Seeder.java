...
public class Seeder {
    ...
    public Seeder(ProductDAO productDAO, UserRepository userRepository, OrderDAO orderDAO, ProductRepository productRepository,GiftCardDAO giftCardDAO) {
    ...
    private void seedGiftCards(){
        System.out.println("Seeder called for gift card");
